...
#
# Created: Fri Feb 08 11:09:42 2008
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.FlashPlayer = QAxContainer.QAxWidget(self.Frame3)
        self.FlashPlayer.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.FlashPlayer.setControl("{D27CDB6E-AE6D-11CF-96B8-444553540000}")
        self.FlashPlayer.setObjectName("FlashPlayer")
        self.vboxlayout.addWidget(self.FlashPlayer)
...
#        MainWindow.setCentralWidget(self.centralWidget)
        ...
        self.PopupMenu.addAction(self.actionNewWindow)
